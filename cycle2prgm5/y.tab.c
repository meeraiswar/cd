...
{
       0,    45,    45,    48,    51,    52,    53,    56,    57,    58,
      59,    62,    65,    66,    69,    82,    84,    86,    88,    90,
      92,    94,    96,   100,   101,   105,   104,   128,   127,   143,
     149,   151,   155,   159,   169,   158
};
#endif
...
#line 1345 "y.tab.c"
  ...
  case 30: /* CONDITION: VAR  */
#line 150 "bnf.y"
            { strcpy((yyval.var), (yyvsp[0].var)); }
#line 1351 "y.tab.c"
    break;

  case 31: /* CONDITION: NUM  */
#line 152 "bnf.y"
            { strcpy((yyval.var), (yyvsp[0].var)); }
#line 1357 "y.tab.c"
    break;
...
#line 1385 "y.tab.c"
  ...
  case 35: /* WHILELOOP: WHILE '(' CONDITION ')' $@3 BLOCK $@4  */
#line 178 "bnf.y"
            {
